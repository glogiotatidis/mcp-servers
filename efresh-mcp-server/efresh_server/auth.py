"""Authentication manager for e-fresh.gr."""
...
class AuthManager:
    ...
    def __init__(self, session_file: Optional[str] = None) -> None:
        ...
        Args:
            session_file: Path to store session data. Defaults to ~/.efresh_session.json
        """
        if session_file is None:
            session_file = str(Path.home() / ".efresh_session.json")
